                                            ...
                                            @endphp
                                                <div class="bookmark" id="bookmarkIcon">
                                                    <form action="{{ route('wishlist.toggleBookmark', $lowongan->id) }}" method="POST" class="bookmark" id="bookmarkForm-{{ $lowongan->id }}">
                                                        @csrf
                                                        <button type="submit" id="bookmarkButton-{{ $lowongan->id }}">
                                        ...
                                        <div class="info">
                                            ...
                                            <div class="isi">
                                                <div class="isi1">
                                                    ...
                                                    <p>Tipe Pekerjaan</p>
                                                    <p>Pendidikan</p>
                                                    <p>Minimal Pengalaman</p>
                                                </div>
                                                <div class="isi2">
                                                    <p style="color: red;">gaji</p>
                                                    <p>{{ $selectedLowongan->tipePekerjaan }}</p>
                                                    <p>{{ $selectedLowongan->pendidikan }}</p>
                                                    <P>{{ $selectedLowongan->pengalaman}}</P>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="button">
                            ...
                            <div class="content-lowongan">
                                <div class="content-view">
                                    <div class="viewdetails-before">
                                        ...
                                        <img src="/img/view-job.png" width="650px">
                                    </div>
                                </div>
                            </div>
                            @endif
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form>
                                    ...
                                    <button type="submit" class="btn btn-primary" onclick="validatePassword()">MASUK</button>
                                ...
                                <div class="btn-job">
                                    <div class="card-body">
                                        ...
                                        <div class="job-info">
                                            ...
                                            <div class="apply-save">
                                                <div class="btn-apply">
                                                    <div class="btn btn-primary-blue" id="apply" data-bs-toggle="modal" data-bs-target="#exampleModal">LAMAR</div>
                                                </div>
                                                {{-- <div class="bookmark" id="leftBookmarkIcon" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                    <i class="bi bi-bookmark"></i>
                                                </div> --}}
                                                <script>
                                                document.addEventListener('DOMContentLoaded', function() {
                            ...
                            <div class="detail-lowongan">
                                <div class="content-lowongan">
                                    ...
                                    <div class="informasi-lowongan">
                                        ...
                                        <div class="button">
                                            <div class="lamar">
                                                <a href="javascript:void(0)" class="btn btn-primary-blue" id="apply1" data-bs-toggle="modal" data-bs-target="#exampleModal">LAMAR</a>
                                            </div>
                                            <div class="bookmark1" id="rightBookmarkIcon">
                                                <div class="simpan">
                                                    <i class="bi bi-bookmark"></i>
                                ...
                                <div class="content-lowongan">
                                    <div class="content-view">
                                        <div class="viewdetails-before">
                                            ...
                                            <h4>Pilih Pekerjaan</h4>
                                            <p>Detail pekerjaan akan ditampilkan disini</p>
                                            <img src="/img/view-job.png" alt="view" width="650px">
                                        </div>
                                    </div>
                                </div>
                            @endif
